    ...
    <div className="topbar">
      <div className="container">
        <div className="topbar__left">
          {userInfo ? (
            <a className="space" href="https://ecommerce-seller.surge.sh">
              Kênh người bán
            </a>
          ) : (
            <Link to="/seller-login" className="space">
              Kênh người bán
            </Link>
          )}
          <Link to="/taiungdung" className="space">
            Tải ứng dụng
          </Link>
            ...
            <li className="topbar__link ">
              {loading ? (
                ...
                <div className="reg__login">
                  ...
                  <Link to="/register" className="re-end">
                    Đăng ký
                  </Link>
                </div>
              )}
