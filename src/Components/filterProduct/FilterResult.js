        ...
        <>
          <div className="shopee-sort-bar">
            ...
            <div className="shopee-sort-by-options">
              <div className="shopee-sort-by-options__option shopee-sort-by-options__option--selected">
                Phổ biến
              </div>
                ...
                <div className="select-with-status">
                  <div className="select-with-status__holder select-with-status__box-shadow">
                    ...
                    <span>
                      ...
                      >
                        <path
                          d="M9.7503478 1.37413402L5.3649665 5.78112957c-.1947815.19574157-.511363.19651982-.7071046.00173827a.50153763.50153763 
                            ...
                            10 .35614224 10 .79546595c0 .20495443-.077512.39180497-.2048207.53283641l.0003896.00038772-.0096728.00972053a.80044712.80044712 0 0 1-.0355483.03572341z"
                          fillRule="nonzero"
                        ></path>
                      </svg>
                    </span>
                  ...
                  <div>
                    <div className="select-with-status__dropdown shopee-modal__transition-exit shopee-modal__transition-exit-active">
                      <div className="select-with-status__dropdown-item select-with-status__dropdown-item--with-tick">
                        Giá: Thấp đến Cao
                      </div>
                      <div className="select-with-status__dropdown-item select-with-status__dropdown-item--with-tick">
                        Giá: Cao đến Thấp
            ...
            <div className="shopee-mini-page-controller">
              <div className="shopee-mini-page-controller__state">
                ...
                /
                <span className="shopee-mini-page-controller__total">
                  {Math.ceil(data.pagination.totalRow / data.pagination.limit)}
                </span>
              </div>
            </div>
          </div>
