                        ...
                        <div className="carousel-content">
                            ...
                            <ul className="carousel__item-list" style={{ width: `${product.length % 2 === 0 ? Math.ceil((product.length / 2) - 1) * 25 : Math.ceil((product.length / 2)) * 25}%`, transform: `translate(${translate}px,0px)` }}>
                                ...
                                <li className="image-carousel__item">
                                    <div class="ofs-seemore__content">
                                        Xem tất cả
                                    <div class="ofs-seemore__arrow">
                                            <svg enableBackground="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0" class="shopee-svg-icon icon-arrow-right">
                                                <path d="m2.5 11c .1 0 .2 0 .3-.1l6-5c .1-.1.2-.3.2-.4s-.1-.3-.2-.4l-6-5c-.2-.2-.5-.1-.7.1s-.1.5.1.7l5.5 4.6-5.5 4.6c-.2.2-.2.5-.1.7.1.1.3.2.4.2z">
                                                </path>
                                            </svg>
                                        </div>
