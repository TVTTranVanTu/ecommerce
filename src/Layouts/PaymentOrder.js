...
function PaymentOrder(props) {
    ...
    const placeOrderHandler = () => {
        if (userInfo) {
            dispatch(createOrder({ itemList: cartItems, billingInfo: shippingAddress, user: userInfo.userDto }));
        }
    }
    useEffect(() => {
        if (success) {
        ...
        <div>
                                        ...
                                        cartItems.map((item) => (
                                            <div className="_3HkBPE _3vbMPD" key={item.product}>
                                                <div className="_1ASQkt _2rJzUE">
                                                    <img className="_1Qtf1H" src={item.productThumbnail} width="40" height="40" />
                                                ...
                                                <div className="_1ASQkt _2z5WqO">₫{item.productPrice * item.qty}</div>
                                            </div>
                                        ))
                                    }
            ...
            <div className="f23wB9">
                    ...
                    <div>
                        <div className="checkout-payment-method-view__current checkout-payment-setting">
                            ...
                            <div className="checkout-payment-setting__payment-methods-tab">
                                ...
                                <span>
                                    <button className="product-variation" disabled>Thẻ Tín dụng/Ghi nợ</button>
                                </span>
                                <span>
                                    <button className="product-variation" disabled>Thẻ ATM nội địa (Internet Banking)</button>
                                </span>
                                <span>
                                    <button className="product-variation product-variation--selected">
                                        Thanh toán khi nhận hàng
                                        <div className="product-variation__tick">
                                            <svg enableBackground="new 0 0 12 12" viewBox="0 0 12 12" x="0" y="0" className="shopee-svg-icon icon-tick-bold">
                                                <g>
                ...
                <div className="PC1-mc">
                    ...
                    <div className="_1i3wS2 _20-5lO lsNObX _3QL9JJ">₫{cartItems.reduce((a, b) => a + b.productPrice * b.qty, 0)}</div>
                    <div className="_3Q9F5R _1Q3ggw">
                        ...
                        <button className="stardust-button stardust-button--primary stardust-button--large _1qSlAe _2a74ER"
                            onClick={placeOrderHandler} >Đặt hàng</button>
                    </div>
                </div>
            </div>
        </div>
