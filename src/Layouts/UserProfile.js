                            ...
                            <li>
                                <Link onClick={() => { setHidden('account') }} to="/account">
                                    <div className="sidebar-menu-entry">
                                        <div className="sidebar-menu-entry__icon" style={{ backgroundColor: "rgb(255, 193, 7)" }}>
                                            <svg enableBackground="new 0 0 15 15" viewBox="0 0 15 15" x="0" y="0" className="shopee-svg-icon user-page-sidebar-icon icon-headshot">
                                                <g>
