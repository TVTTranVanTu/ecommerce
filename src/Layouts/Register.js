    ...
    return (
        <div >
                ...
                <div className="register" >
                    ...
                    <div>
                        <form className="form" onSubmit={submitHandler}>
                            ...
                            <button className="mr__bt ant-btn ant-btn-primary btn btn_orange w100" type="submit"
                                onClick={checkOtpHandle}>Đăng ký</button>
            ...
            <div style={{ display: ` ${check === false ? 'none' : 'block'}` }} >
                <CheckOTPBox email={email} redirect={redirect} history={props.history} />
            </div>
        </div>
    );
}
